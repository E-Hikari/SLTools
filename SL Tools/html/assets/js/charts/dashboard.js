(function (jQuery) {
  ...
  if (document.querySelectorAll("#sales-chart-02").length) {
    ...
    const options = {
      series: [{
        name: "Adquiridas",
        data: [40, 62, 70, 88, 67, 84, 100, 91, 148, 122, 102, 70]
        },
        {
          name: "Utilizadas",
          data: [38, 41, 35, 51, 49, 72, 62, 78, 92, 111, 83, 55]
      }],
      colors: colors,
      chart: {
        height: "100%",
  ...
  if (document.querySelectorAll("#sales-chart-04").length) {
    ...
    labels: ['Disponíveis: 14202', 'Utilizadas: 55798'],
    legend: {
      position: 'bottom',
    },
    responsive: [{
  ...
  if (document.querySelectorAll("#analytics-chart-01").length) {
    ...
    xaxis: {
      categories: ['Jan', 'Fev', 'Mar', 'Abr', 'Mar', 'Jun', 'Jul', 'Ago', 'Set', 'Out', 'Nove', 'Dec'],
      labels:{
        minHeight: 20,
        maxHeight: 20
      }
